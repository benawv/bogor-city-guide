...
<div class="container boxes-view">
	...
	<div>
		...
		<?php echo $this->areablock('container', array('allowed' => array(
			...
			'smartwealth-factsheet', 'imagekiri-tabelkanan', 'sitemap', 'brosur','kalkulator-investasi', 'asn-center', 'gridlanding','artikelalanding','landing-informasi-produk','profil-maker','profil-maker-create','profil-maker-setting'))); ?>
