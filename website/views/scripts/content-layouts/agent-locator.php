...
<div class="container boxes-view">
	...
	<div class="wrapper-special clearfix">
		<?php echo $this->areablock('banner', array(
					"allowed" => array("gallery-carousel-agent","map-agent-locator")))?>
		<!--<div id="quicklinks">
	...
	<div>
		...
		<?php echo $this->areablock('container', array('allowed' => array(
			...
			'smartwealth-factsheet', 'imagekiri-tabelkanan', 'sitemap', 'brosur','kalkulator-investasi','teks-ahenalocator'))); ?>
