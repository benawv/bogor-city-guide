...
<?php echo $this->areablock('halaman-ajfc', array('allowed' => array('pendaftaran','daftar-peserta','thanks-page','expire-page','home-ajfc','table-text','table-li','proses-seleksi','galeri-ajfc')))?>