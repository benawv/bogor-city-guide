...
<div role="main" class="tips-main main" style="background: url(<?php echo "../".$this->data->imageBackgroundDetail->filename;?>);background-size: 1500px auto;background-repeat: no-repeat;">
