            ...
            <div class="description width-66">
                ...
                <div class="section-right-60">
                    ...
                    <?php
                                ...
                                {
                                                        $nilai = ' Rp. '.number_format($session->Calculation*2,0,".",",")." per tahun atau sebesar ".'<br/>Rp. '.number_format($session->Calculation,0,',','.')." per semester.";
                                }
                                elseif($session->Frekuensi == "Triwulan")
                                {
                                                        $nilai = ' Rp. '.number_format($session->Calculation*4,0,".",",")." per tahun atau sebesar ".'<br/>Rp. '.number_format($session->Calculation,0,',','.')." per triwulan.";
