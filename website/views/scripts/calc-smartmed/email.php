...
<table border="0" cellpadding="0" cellspacing="0" class="table table-bordered">
		<tr>
			...
			<td class="text-left nomor"><strong><strong><font color="#111111" face="Roboto, helvetica, arial, sans-serif"><span style="font-size: 12px;"><?php echo $i; ?></span></font></strong></strong></td>
            <?php } ?>
		</tr>
		<tr>
