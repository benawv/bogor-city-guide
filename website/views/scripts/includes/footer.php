...
;NREUM.info={beacon:"bam.nr-data.net",errorBeacon:"bam.nr-data.net",licenseKey:"27091a9540",applicationID:"16345077",sa:1,agent:"js-agent.newrelic.com/nr-686.min.js"}
</script>
<?php
if(!$this->editmode){
