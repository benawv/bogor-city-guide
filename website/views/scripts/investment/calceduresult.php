...
<!--
           <div class="calc-machine">
               ...
               <div class="share">
                    <span>Ingin menghitung kembali? <a href="/kalkulator/financial-calculators/pendidikan">klik disini >></a></span>
                </div>
...
function setCookie(cname, cvalue, exdays) {
    ...
    <?php $session = new Zend_Session_Namespace('HitEdu'); ?>
	...
	edu1_biaya_bulanan = accounting.formatMoney(<?php echo $session->biaya; ?>,'Rp ',2,'.',',');
    ...
    <?php Zend_Session::namespaceUnset('HitEdu'); ?>