...
<div role="main" class="main calc">
       ...
       <div class="calc-wrap">
           ...
           <div class="calc-machine">
               <div id="demo">
                   <div class="calc-box-title"> 
                        ...
                        <div id="for_desktop" class="sub_form">Estimasi biaya pendidikan untuk KB/TK/SD/SMP/PT saat ini *<span class='appendix' style="cursor: pointer; color: blue;">acuan</span></div>
             ...
             <div class="calc-machine">
               <div id="demo2">
                   <div class="calc-box-title"> 
                        <div class="title-box"><h4>ASUMSI IMBAL HASIL TAHUNAN</h4></div>
           ...
           <div class="calc-machine">
               <div class="calc-submit bottom">
                    <input class="orange-btn bg_edu" type="button" value="Hitung Investasi Bulanan / Tahunan yang Saya Butuhkan">
                </div>   
           </div>   
    ...
    <div class="calc-overlay" id="overlayAppendixs">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
             ...
             $('.appendix').click(function(){
                //alert('sdasa');
                $('#overlayAppendixs').css('display','block');
                });
