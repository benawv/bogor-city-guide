...
<script type="text/javascript">
	...
	function getCookie(cname) {
        ...
        $('#sliderPosition').val(getCookie('pension1_hasil'));
        $('#sliderPosition3').val(getCookie('pension1_jangka_waktu'));
        ...
        $(".orange-btn").click(function(){
            var result = pension2($("#sliderPosition").val(),
               $("#sliderPosition2").val(),
               $("#sliderPosition3").val()
               );
            
            setCookie('pension2_biaya',$("#sliderPosition").val(),1);
            setCookie('pension2_asumsi_inflasi',$("#sliderPosition2").val(),1);
            setCookie('pension2_jangka_waktu',$("#sliderPosition3").val(),1);
            setCookie('pension2_hasil',result,1);
            
            window.location.href = "/investasi/investment-homepage/tools/financial-calculators/calculator-retirement-result2";
        });
