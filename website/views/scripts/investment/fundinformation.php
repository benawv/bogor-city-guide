...
<ul id="membername" class="navi" style="">
	...
	<li <?php if($urlExplode[4]=="balanced"){ ?> class="aktif" <?php } ?> >
		...
		<div class="nav_menu">
			...
			<div class="white_image" style="margin-bottom: 3px; width: 25px; height: 25px; <?php if($urlExplode[4]=="balanced"){ ?> display: block; <?php } else{ ?> display: none; <?php } ?> background-image: url(http://www.allianz.co.id/icon_anchor/icon-active/tentang-kami.png);"></div>
