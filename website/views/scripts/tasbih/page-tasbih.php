...
<?php echo $this->areablock('halaman-ajfc', array('allowed' => array('sudah-submit','pendaftaran','daftar-peserta','thanks-page','expire-page','home-tasbih','table-text','table-li','proses-seleksi','galeri-ajfc')))?>