...
<?php echo $this->areablock('halaman-tasbih', array('allowed' => array('sudah-submit','pendaftaran','daftar-peserta','thanks-page','expire-page','home-tasbih','table-text','table-li','proses-seleksi','galeri-ajfc','cari-agen-syariah','inquiry-form')))?>