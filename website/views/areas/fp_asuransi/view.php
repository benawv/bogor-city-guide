			...
			new stepsForm( theForm, {
				onSubmit : function( form ) {
					...
					*/
					...
					messageEl.innerHTML = 'FAKTA <br> <h3>Pertanggungan sebesar </h3><h2>'+result+'</h2><h3> akan memastikan apabila meninggal dunia mereka yang dicintai tetap akan terdukung secara finansial.<br> <a style="color:#F1295B !important" href= "/kalkulator/financial-calculators/pertanggungan"> Mari mulai perencanaan asuransi anda ></a></h3><h3><a style="color:#F1295B !important" href="#" onclick="window.location.href=window.location.href">Ulangi lagi ></a></h3>';
