    ...
    <header style="margin: 0px -15px 0px -15px;">
        <nav class="main-navigation" style="max-width:960px; margin: 0 auto;">
            <div class="row">
                ...
                <!--<div class="col-xs-12 col-md-2" style="min-width:20%; min-height:50px; margin:auto; !important">
                    <a href="/produk/asuransi-syariah/tasbih/info-produk#anchor5" class="nav-item green sitemap" style="height: 48px !important;">
                        <h4 style="font-size:18px"><small>Proyeksi Dana</small></h4>
                    </a>
                </div>-->
                <!--/ .col-xs-12 -->
                <div class="col-xs-12 col-md-2" style="min-width:20%; min-height:50px; margin:auto; !important">
                    <a href="http://agen.allianz.co.id" target="_blank" class="nav-item red users" style="height: 48px !important;background:#5F259F;">
