    ...
    <header style="margin: 0px -15px 0px -15px;">
        <nav class="main-navigation" style="max-width:960px; margin: 0 auto;">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-2" style="min-width:20%; min-height:50px; margin:auto; !important">
                    <a href="/kalkulator/ilustrasi" class="nav-item green sitemap" style="height: 48px !important;">
                        <h4 style="font-size:18px"><small>Ilustrasi</small></h4>
                    </a>
                </div><!--/ .col-xs-12 -->
                <div class="col-xs-12 col-md-2" style="min-width:20%; min-height:50px; margin:auto; !important">
                    <a href="/tasbih/info-produk" class="nav-item orange question" style="height: 48px !important;">
                ...
                <div class="col-xs-12 col-md-2" style="min-width:20%; min-height:50px; margin:auto; !important">
                    <a href="/tasbih/minta-informasi" class="nav-item grey chat" style="height: 48px !important;">
