			...
			new stepsForm( theForm, {
				onSubmit : function( form ) {
					...
					*/
					...
					messageEl.innerHTML = '<h3>Jumlah tersebut saat ini hanya cukup untuk bersekolah selama </h3><h1 style="margin:0px;">'+result+' hari</h1><h3> Secara rata-rata kenaikan biaya pendidikan di Indonesia dua kali lipat dari kenaikan harga barang-barang secara umum <br><br /> Ingin melakukan kalkulasi biaya pendidikan Anda?<br/><br><a href= "/kalkulator/financial-calculators/pendidikan"> Mari mulai perencanaan pendidikan Anda ></a></h3><div class="fp_separator"></div><h3 style="margin-top:0px;"><a  href="#" onclick="window.location.href=window.location.href">Ulangi lagi ></a></h3>';
