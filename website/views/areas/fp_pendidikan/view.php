			...
			new stepsForm( theForm, {
				onSubmit : function( form ) {
					...
					*/
					...
					messageEl.innerHTML = 'Jumlah tersebut saat ini hanya cukup untuk bersekolah selama <br>' + result + ' hari <br><br> FAKTA <br> <h3>Secara rata-rata kenaikan biaya pendidikan di Indonesia dua kali lipat dari kenaikan harga barang-barang secara umum <br><br /> Ingin melakukan kalkulasi biaya pendidikan Anda? <br> <a href= "/investment/kalkulator/financial-calculators/pendidikan"> Mari mulai perencanaan pendidikan anda </a></h3><h3><a href="#" onclick="window.location.href=window.location.href">Ulangi lagi</a></h3>';
