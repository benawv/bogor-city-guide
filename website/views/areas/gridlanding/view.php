...
<?php }?>
                ...
                <div class="landing-tasbih-map" style="height:335px !important;">
                    ...
                    <div class="landing-tasbih-map--button">
                        <a href='http://www.allianz.co.id/agent-locator/agen/' target="_blank"><i class="fa fa-search"></i> Temukan Agen</a>
...
<script type="text/javascript">
    ...
    function initialize() {
        ...
        var mapSearch = function() {
            ...
            //		map: map,
            //		icon: 'http://www.allianz.co.id/agent-locator/agen//css/img/map-pointer-green.png',
            ...
            //			  map: map,
            //			  icon: 'http://www.allianz.co.id/agent-locator/agen//css/img/pointer-blue.png'
            //			});
            //
			...
			"success" : function(responseData){
			    ...
			    for(x=0;x < markers.length;x++){
				    ...
				    google.maps.event.addListener(marker, 'click', function () {
						...
						window.open('http://www.allianz.co.id/agent-locator/agen/', '_blank');
						//window.location.href = "http://www.allianz.co.id/agent-locator/agen/";
				    });
			    }
