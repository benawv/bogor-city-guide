    ...
    <div class="description">
        ...
        <div class="wizard-container">
            ...
            <div class="card wizard-card ct-wizard-blue customArrow" id="wizard">
                ...
                <ul>
                    <li class="first active"><a href="#data-mobil" data-toggle="tab"><i class="fa fa-car fa-2x"></i>&nbsp;&nbsp;&nbsp;Data Mobil</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="data-mobil">
                        <div class="row">
                            <div class="col-sm-12">
...
//        document.cookie = "tahun_pembuatan='"$('#tahun_pembuatan').value()"'";
//        document.cookie = "harga='"$('#harga').value()"'";
//        document.cookie = "merk='"$('#merk').value()"'";
//        document.cookie = "model='"$('#model').value()"'";
