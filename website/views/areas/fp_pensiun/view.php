			...
			new stepsForm( theForm, {
				onSubmit : function( form ) {
					...
					*/
					...
					messageEl.innerHTML = 'FAKTA <br> <h3>Anda membutuhkan </h3><h2>'+result+'</h2><h3> Untuk menikmati gaya hidup Anda saat ini di masa pensiun setiap bulannya <br> <a style="color:#CD7A3F" href= "/kalkulator/financial-calculators/pensiun"> Mari mulai perencanaan pensiun anda ></a></h3><h3><a href="#" style="color:#CD7A3F" onclick="window.location.href=window.location.href">Ulangi lagi ></a></h3>';
