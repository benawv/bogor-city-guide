...
ALTER TABLE `object_query_4` ADD COLUMN `categories__id` int(11) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_4` ADD COLUMN `categories__type` enum('document','asset','object') NULL;

/*--NEXT--*/

ALTER TABLE `object_query_4` DROP INDEX `p_index_categories__id`;

/*--NEXT--*/

ALTER TABLE `object_query_4` DROP INDEX `p_index_categories__type`;

/*--NEXT--*/

ALTER TABLE `object_store_4` DROP INDEX `p_index_categories__id`;

/*--NEXT--*/

ALTER TABLE `object_store_4` DROP INDEX `p_index_categories__type`;
...
ALTER TABLE `object_query_4` DROP COLUMN `categories`;
