...
ALTER TABLE `object_query_7` ADD COLUMN `alamat` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `alamat` varchar(255) NULL;
