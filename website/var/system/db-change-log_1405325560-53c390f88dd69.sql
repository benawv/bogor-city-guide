...
ALTER TABLE `object_query_5` ADD COLUMN `category` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_5` ADD COLUMN `category` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_query_5` DROP INDEX `p_index_category`;

/*--NEXT--*/

ALTER TABLE `object_store_5` DROP INDEX `p_index_category`;
