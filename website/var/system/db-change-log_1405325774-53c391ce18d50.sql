...
ALTER TABLE `object_query_4` CHANGE COLUMN `categories` `categories` text NULL;
...
ALTER TABLE `object_query_4` ADD COLUMN `links` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_4` ADD COLUMN `links` varchar(255) NULL;
