...
ALTER TABLE `object_query_7` ADD COLUMN `latitude` varchar(255) NULL;

/*--NEXT--*/

ALTER TABLE `object_store_7` ADD COLUMN `latitude` varchar(255) NULL;
